    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12">
            ...
            <div class="md:col-span-5">
                <div class="flex items-center space-x-4 mb-6">
                    ...
                    <div>
                        ...
                        <p class="text-yellow-400 text-xs font-bold uppercase tracking-widest mt-0.5">International Relations Office</p>
                    </div>
                </div>
            ...
            <div class="md:col-span-3 md:col-start-7">
                <h4 class="font-bold tracking-wider mb-6 text-yellow-400 uppercase text-sm">Explore</h4>
            ...
            <div class="md:col-span-3">
                <h4 class="font-bold tracking-wider mb-6 text-yellow-400 uppercase text-sm">Resources</h4>
                <ul class="space-y-3 text-sm font-medium text-red-100">
