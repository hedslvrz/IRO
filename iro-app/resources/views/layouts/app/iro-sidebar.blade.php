            ...
            <div class="flex items-center h-16">
                ...
                <div class="flex-1 overflow-x-auto flex items-center pl-6 space-x-2 no-scrollbar">
                    ...
                    <a href="{{ route('izn') }}" class="flex items-center gap-2 px-3 py-2 rounded-md text-sm whitespace-nowrap transition duration-200 group {{ request()->routeIs('izn') ? 'bg-red-50 text-emerald-900 font-semibold' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 font-medium' }}">
                        ...
                        IZN Programs
                        <svg class="w-3.5 h-3.5 ml-1 {{ request()->routeIs('izn') ? 'text-emerald-900' : 'text-gray-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7"></path></svg>
                    </a>
                    ...
                    <a href="{{ route('intl-net') }}" class="flex items-center gap-2 px-3 py-2 rounded-md text-sm whitespace-nowrap transition duration-200 group {{ request()->routeIs('intl-net') ? 'bg-red-50 text-emerald-900 font-semibold' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 font-medium' }}">
                        <svg class="w-4 h-4 {{ request()->routeIs('intl-net') ? 'opacity-75' : 'text-gray-400 group-hover:text-gray-600 transition' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
                        Intl. Networks
                    </a>
