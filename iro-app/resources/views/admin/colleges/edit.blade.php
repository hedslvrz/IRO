        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border-t-4 border-red-700">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('colleges.update', $college->id) }}" method="POST" class="space-y-6">
                        @csrf
                        {{-- Laravel needs this to know it's an update, not a creation --}}
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <input type="text" name="slug" id="slug" value="{{ old('slug', $college->slug) }}"
                                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm">
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="4" required
                                      class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm">{{ old('description', $college->description) }}</textarea>
                        </div>
